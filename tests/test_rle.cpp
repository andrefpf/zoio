...
void test_encode_rle() {
    std::vector<int> original = {0, 0, 0, 0, 0, 2, 0, 0, 0, 4, 0,
                                 0, 0, 0, 0, 0, 6, 0, 0, 2, 0, 1,
                                 0, 0, 0, 0, 0, 0, 0, 6, 0, 0, 0};
    std::vector<int> expected = {0, 5, 2, 0, 3, 4, 0, 6, 6, 0,
                                 2, 2, 0, 1, 1, 0, 7, 6, 0, 3};
...
void test_decode_rle() {
    std::vector<int> original = {0, 5, 2, 0, 3, 4, 0, 6, 6, 0,
                                 2, 2, 0, 1, 1, 0, 7, 6, 0, 3};
    std::vector<int> expected = {0, 0, 0, 0, 0, 2, 0, 0, 0, 4, 0,
                                 0, 0, 0, 0, 0, 6, 0, 0, 2, 0, 1,
                                 0, 0, 0, 0, 0, 0, 0, 6, 0, 0, 0};
...
TEST_LIST = {{"Encode RLE", test_encode_rle},
